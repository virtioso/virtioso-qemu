...
DEF("machine", HAS_ARG, QEMU_OPTION_machine, \
    ...
    "                supported accelerators are kvm, xen, sel4, hvf, nvmm, whpx or tcg (default: tcg)\n"
...
``-machine [type=]name[,prop=value[,...]]``
    ...
    ``accel=accels1[:accels2[:...]]``
        ...
        architecture, kvm, xen, sel4, hvf, nvmm, whpx or tcg can be available.
...
DEF("accel", HAS_ARG, QEMU_OPTION_accel,
    ...
    "                select accelerator (kvm, xen, sel4, hvf, nvmm, whpx or tcg; use 'help' for a list)\n"
...
``-accel name[,prop=value[,...]]``
    This is used to enable an accelerator. Depending on the target
    architecture, kvm, xen, sel4, hvf, nvmm, whpx or tcg can be available. By
